        ...
        <div class="container-login100">
            <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
                <form action="" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Kelas harus diisi!">
                        <span class="label-input100">Kelas</span>
                        <input class="input100" type="text" name="kelas" placeholder="kelas...">
                        <span class="focus-input100"></span>
                    </div>
                    ...
                    <div class="container-login100-form-btn">
                        ...
                        <a href="index.php" class="dis-block txt3 hov2">
                            Masuk
